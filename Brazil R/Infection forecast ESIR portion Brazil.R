...
# Brazil province data Oct 01 -> April 01
# Cumulative number of infected cases
NI_complete <- brazil$cases_total
# Cumulative number of removed cases
RI_complete <- brazil$recoveries_total
N <- 215633189
R <- RI_complete / N
Y <- NI_complete / N - R #Oct 01 -> April 01

### Step function of pi(t)
change_time <- c("10/01/2020", "01/14/2021", "01/17/2021", "04/01/2021")
pi0 <- c(1.0, 0.9, 0.5, 0.5,0.5)
res.step <- tvt.eSIR(Y, 
                     R, 
                     begin_str = "10/01/2020",
                     T_fin = 183,
                     pi0 = pi0, 
