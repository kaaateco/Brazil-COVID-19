...
library(tidyverse)
library(ggplot2)
periods <- function(date_initial, date_final, I0, R0){
  # Set date ranges ----
...
binder1 <- periods(as.Date("2020-10-01"), as.Date("2020-11-01"), 1000, 2000)
binder2 <- periods(as.Date("2020-11-01"), as.Date("2020-12-01"), 1000, 2000)
binder3 <- periods(as.Date("2020-12-01"), as.Date("2021-01-01"), 1000, 2000)
binder4 <- periods(as.Date("2021-01-01"), as.Date("2021-02-01"), 1000, 2000)
binder5 <- periods(as.Date("2021-02-01"), as.Date("2021-03-01"), 1000, 2000)
binder6 <- periods(as.Date("2021-03-01"), as.Date("2021-04-01"), 1000, 2000)
...
p1 = base +
  ...
  geom_bar(mapping = aes(x = date, y = pred_I), stat = "identity",
           data = bind, width = 0.5, fill = 'steelblue', alpha = 0.7,
  ) #+
  #xlim(date_initial, date_final)
p1 = p1 + labs(y = "Active Cases")
 #ggsave("Cases_8months.pdf",p1,width=8, height=6)
p2 = base +
  geom_line(mapping = aes(x = date, y = pred_R, color = colour),
            data = bind, size = 1,color = mn) +
  geom_bar(mapping = aes(x = date, y=pred_R), stat="identity",
           data = bind, width = 0.5, fill = 'steelblue', alpha = 0.7) #+
